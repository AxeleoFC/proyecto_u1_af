...
public class TransaccionServiceImpl implements ITransaccionService {
	...
	@Autowired
	private IDepositoRepository iDepositoRepsotory;
	@Autowired
	...
	@Override
	public void retiro(String destino, BigDecimal monto) {
		// TODO Auto-generated method stub
		this.iRetiroService.realizarRetiro(destino, monto);
	}
	...
	public List<TransaccionTo> consultar(String cuenta, LocalDateTime fechaInicio, LocalDateTime fechaFin) {
		...
		List<Deposito> listaDepo=this.iDepositoRepsotory.consultar(cuenta, fechaInicio, fechaFin);
